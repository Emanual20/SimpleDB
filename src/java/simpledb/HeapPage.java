...
public class HeapPage implements Page {
    ...
    private TransactionId dirty_id;
    ...
    */
    ...
    private int getHeaderSize() {
        // some code goes here
        int ret_HeaderSize=this.numSlots/8;
        if(this.numSlots%8!=0) ret_HeaderSize+=1;
        return ret_HeaderSize;
    }
    ...
    public void insertTuple(Tuple t) throws DbException {
        ...
        if(getNumEmptySlots()==0) throw new DbException("the page is fool");
    ...
    public Iterator<Tuple> iterator() {
        // some code goes here
        ArrayList<Tuple> Tuple_list=new ArrayList<>();
        for(int i=0;i<numSlots;i++){
            if(isSlotUsed(i)){
